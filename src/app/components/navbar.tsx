        ...
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center gap-2">
            <Image
              ...
              height={35}
            />
            <h1 className="text-2xl md:text-3x text-black font-bold uppercase">
              Brasika I
            </h1>
          </div>
          <nav className="hidden md:flex gap-10 uppercase">
            ...
            <Link
              href="/about"
              className="text-black hover:text-gray-600 group">
              About
          ...
          <div className="flex items-center gap-4">
            <button
              ...
              className="hidden md:inline-block bg-black text-white px-4 py-2 rounded-md hover:bg-gray-800 transition">
              Login Admin
            </button>
