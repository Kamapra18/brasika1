  ...
  return (
    <footer className="bg-gray-900 !text-gray-200 pt-10">
      <div className="container mx-auto px-4 md:px-12 lg:px-20">
        ...
        {/* Deskripsi */}
        <motion.p
          className="text-center !text-gray-200 max-w-2xl mx-auto text-sm leading-relaxed mb-6"
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
          transition={{ duration: 0.6, delay: 0.4 }}
          viewport={{ once: false }}>
          Sekaa Teruna Teruni Brasika Asta Dharma I adalah wadah bagi generasi
          muda Banjar untuk berkarya, melestarikan budaya, dan mempererat
          kebersamaan.
        </motion.p>
        ...
        <motion.div
          ...
          viewport={{ once: false }}>
          <a
            href="https://wa.me/6285739122445"
            className="!text-gray-200 hover:!text-[#1ebe5d]"
            target="_blank">
            <FaWhatsapp size={20} />
          </a>
          <a
            href="https://www.instagram.com/brasika.1?igsh=MWs3MGdhaDliZ2oxbw=="
            className="!text-gray-200 hover:!text-pink-400"
            target="_blank">
            <FaInstagram size={20} />
          </a>
          <a
            href="https://www.facebook.com/bersamapekandelan?locale=id_ID"
